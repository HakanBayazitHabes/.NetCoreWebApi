...
public class AuthenticationManager : IAuthenticationService
{
    ...
    {
        var signinCreddentials = GetSigningCredentials();
        var claims = await GetClaims();
        var tokenOptions = GenerateTokenOptions(signinCreddentials, claims);
    ...
    private JwtSecurityToken GenerateTokenOptions(SigningCredentials signinCreddentials, List<Claim> claims)
    {
        var jwtSettings = _configuration.GetSection("JwtSettings");
        ...
        var tokenOptions = new JwtSecurityToken(
            ...
            signingCredentials: signinCreddentials
        );
